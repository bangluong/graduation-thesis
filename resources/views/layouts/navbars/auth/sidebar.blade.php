<?php
    $user = Auth()->user();
    $acl = \App\Models\Acl::find($user->acl);
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        ...
        @if(in_array(0, $resource) || in_array('category', $resource))
        <li class="nav-item mt-2">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{__('Danh Mục')}}</h6>
        </li>
            <li class="nav-item">
        ...
        @endif
        @if(in_array(0, $resource) || in_array('orders', $resource))
        <li class="nav-item mt-2">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{__('Đơn Hàng')}}</h6>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ (Request::is('orders') ? 'active' : '') }} " href="{{ url('admin/orders') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <title>Products</title>
                        <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        @endif
        @if(in_array(0, $resource) || in_array('attribute', $resource))
        <li class="nav-item mt-2">
            <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{__('Thuộc Tính')}}</h6>
        </li>
        <li class="nav-item">
            <a class="nav-link {{ (Request::is('admin/attributes') ? 'active' : '') }} " href="{{ url('admin/attributes') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <li class="nav-item pb-2">
            <a class="nav-link {{ (Request::is('admin/attribute_set') ? 'active' : '') }}" href="{{ url('admin/attribute_set') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('category') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                </div>
                <span class="nav-link-text ms-1">Bộ Thuộc Tính</span>
            </a>
        </li>
        @endif
        @if(in_array(0, $resource) || in_array('user', $resource))
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Quản Trị Viên</h6>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item pb-2">
        ...
        <li class="nav-item pb-2">
            <a class="nav-link {{ (Request::is('admin/acl') ? 'active' : '') }}" href="{{ url('admin/acl') }}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('user-management') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
                </div>
                <span class="nav-link-text ms-1">Quản Lý Quyền Truy Cập</span>
            </a>
        </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('customer') ? 'active' : '') }}" href="{{ url('admin/customer') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>customer-support</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
          ...
          <span class="nav-link-text ms-1">Danh Sách Người Dung</span>
        </a>
      </li>
        @endif
    </ul>
  ...
  <div class="sidenav-footer mx-3 ">
    <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
      ...
      <div class="card-body text-start p-3 w-100">
        ...
        <div class="docs-info">
          <h6 class="text-white up mb-0">Cần Giúp Đỡ?</h6>
          <p class="text-xs font-weight-bold">Liên Hệ với chúng tôi</p>
