    ...
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            <div class="d-flex align-items-center mb-4 pt-2">
                <form action="{{url('checkout/cart/add')}}" method="POST" enctype="multipart/form-data" class="d-flex align-items-center mb-4 pt-2">
                    @csrf
                    <div class="input-group quantity mr-3" style="width: 130px;">
                        <input size="4" step="1" min="1" max="5" type="number" class="input-text qty text form-control" name="qty" value="1">
            ...
            <div class="full">
                <div class="tab_bar_section">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#detail">Thông Số Kĩ Thuật</a> </li>
                    </ul>
                    <!-- Tab panes -->
