...
@section('content')
    ...
    <div>
        ...
        <form action="{{url('/admin/customer/update')}}" method="POST" role="form text-left" enctype="multipart/form-data">
            <div class="container-fluid py-4">
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <h6 class="mb-0">{{ __('Thông Tin Khách Hàng') }}</h6>
                    </div>
                    <div class="card-body pt-4 p-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-name" class="form-control-label">{{ __('Họ Tên') }}</label>
                                <div class="border rounded-3">
                                    <input class="form-control" value="{{$customer->name}}" type="text" placeholder="name"
                                           id="attribute-label" name="name">
                                    <input class="form-control" value="{{$customer->id}}" type="hidden"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label">{{ __('Ngày Sinh') }}</label>
                                <div class="border rounded-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="border rounded-3">
                                    <input class="form-control" type="email" id="attribute-code" name="qty"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-control-label">{{ __('Số Điện Thoại') }}</label>
                                <div class="border rounded-3">
                                    <input class="form-control" type="text" id="attribute-code" name="sku"
                                           value="{{$customer->sdt}}">
                                </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            @if(count($orders) == 0)
                                <p>Khách hàng chưa có đơn nào</p>
                            @endif
                            <table class="table align-items-start mb-0">
                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">{{number_format($order->subtotal)}}</td>
                                        <td class="align-middle text-center">{{$order->item_count}}</td>
                                        <td class="align-middle text-center">{{$status_mapper[$order->status]}}</td>
                                        <td class="align-middle text-center"><a href="{{url('admin/orders/'.$order->id)}}">Xem</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
