            ...
            <div class="container-fluid py-4">
                <div class="card">
                    <div class="card-header pb-0 px-3">
                        <h6 class="mb-0">{{ __('Chi tiết đơn hàng') }}</h6>
                    </div>
...
{{--                        @endif--}}
                    ...
                    <div class="d-flex justify-content-end" style="margin-right: 100px">
                        <a href="{{url('admin/orders/pdf/'.$order->id)}}"><button type="button" class="btn bg-gradient-light btn-md mt-4 mb-4">{{ 'Xuất Hóa Đơn' }}</button></a>
                    </div>
                </div>
            </div>
        </form>
