                ...
                <div class="card">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p>Test address 4545 Xã Liên Hòa, Huyện Lập Thạch, Tỉnh Vĩnh Phúc, 280000 Vietnam</p>
                            <p>SĐT: 132436</p>
                        </div>
                    </div>
                    <div class="card">
                            ...
                            <table class="table align-items-start mb-0">
                                ...
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">{{$item->old_price}}</td>
                                        <td class="align-middle text-center">{{$item->price}}</td>
                                        <td class="align-middle text-center">{{$item->qty}}</td>
                                        <td class="align-middle text-center">{{$item->row_total}}</td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
                    ...
                    @if($order->status == 0)
                        ...
                        <div class="d-flex justify-content-end" style="margin-right: 100px">
                            <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Tiếp Nhận Đơn Hàng' }}</button>
                        </div>
                    @elseif($order->status == 1)
                        <input type="hidden" name="status" value="2">
                        <div class="d-flex justify-content-end" style="margin-right: 100px">
                            <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Giao Hàng' }}</button>
                        </div>
                    @elseif($order->status == 2)
                        <input type="hidden" name="status" value="3">
                        <div class="d-flex justify-content-end" style="margin-right: 100px">
                            <button type="submit" class="btn bg-gradient-dark btn-md mt-4 mb-4">{{ 'Hoàn Thành' }}</button>
                        </div>
                    @endif
                    @if ($order->status != 3 && $order->status != 4)
                    <div class="d-flex justify-content-end" style="margin-right: 100px">
                        <a href="{{url('admin/orders/cancel/'.$order->id)}}"><button type="button" class="btn bg-gradient-light btn-md mt-4 mb-4">{{ 'Hủy Đơn Hàng' }}</button></a>
                    </div>
                    @endif
                </div>
            </div>
