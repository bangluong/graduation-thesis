                    ...
                    <div class="card-body pt-4 p-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="border rounded-3">
                                    <select class="form-control" id="input-category" name="category[]" multiple>
                                        @foreach($categories as $cate)
                                            <option value="{{$cate['value']}}" {{$cate['is_selected']}}>{{$cate['label']}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="border rounded-3">
                                    <input class="form-control required" type="text" id="attribute-code" name="sale_price"
                        ...
                        <div class="list-images">
                            @if (isset($list_images) && !empty($list_images))
                                @foreach (($list_images) as $key => $img)
                                    <div class="box-image">
                                        <input type="hidden" name="images_uploaded[]" value="{{ $img->filename }}" id="img-{{ $key }}">
                                        <img src="{{ asset('products/'.$img->filename) }}" class="picture-box">
