                ...
                <div class="card">
                    ...
                    <div class="card-body pt-4 p-3 attribute-values">
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tr id="delete_{{$key}}">
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <button type="button" class="btn btn-secondary delete-option" data-del="delete_{{$key}}">Xóa</button>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
                            ...
                            <div>
                                <button type="button" class="btn bg-gradient-info add-option">Thêm Giá trị</button>
                            </div>
                        </div>
                    </div>
