                    ...
                    <div class="card-body pt-4 p-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user-name" class="form-control-label">{{ __('Label') }}</label>
                                <div class="border rounded-3">
                                    <input class="form-control" value="" type="text" placeholder="label"
                                           id="attribute-label" name="label">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="user.phone" class="form-control-label">{{ __('Attribute code') }}</label>
                                <div class="border rounded-3">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="border rounded-3">
                                    <select class="form-control" id="input-type" name="input_type">
                                        <option value="0" selected>Text</option>
                                        <option value="1">Text Swatch</option>
                                        <option value="2">Color Swatch</option>
                                    ...
                                    <tr id="delete_0">
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <input type="text" class="input-value" name="value_0">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <input type="text" name="watch_0">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="d-flex px-2 py-1">
    ...
    <script>
        ...
        function getHtml(number) {
            ...
            return '<tr id="deleted_'+number+'"><td>' +
                '<div class="d-flex px-2 py-1">' +
                '<input class="input-value" type="'+inputType+'" value="" name="value_'+number+'">' +
                '</div> </td>' +
                '<td>' +
                '<div class="d-flex px-2 py-1">' +
                '<input type="text" value="" name="swatch_'+number+'">' +
                '</div> </td>' +
                '<td>' +
                '<div class="d-flex px-2 py-1">' +
